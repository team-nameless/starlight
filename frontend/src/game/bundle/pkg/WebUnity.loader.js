function createUnityInstance(t, n, c) {
    ...
    function h(e) {
        document.webkitCurrentFullScreenElement === t
            ? t.style.width &&
              ((u = t.style.width), (d = t.style.height), (t.style.width = "100%"), (t.style.height = "100%"))
            ...
            l.addRunDependency("dataUrl"),
                o.then(function (e) {
                    ...
                    for (n += 4; n < o; ) {
                        ...
                        n += s;
                        for (var u = 0, d = c.indexOf("/", u) + 1; 0 < d; u = d, d = c.indexOf("/", u) + 1)
            ...
            var d,
                ...
                h =
                    ((h = document.createElement("canvas")) &&
                        ...
                        f &&
                            (r =
                                (f.getExtension("WEBGL_debug_renderer_info") && f.getParameter(37446)) ||
                                f.getParameter(7937))),
            ...
            (x.prototype.cleanUpCache = function () {
                ...
                return this.getMetaDataEntries().then(function (e) {
                    for (var t = e.metaDataEntries, n = e.cacheSize, r = [], o = [], a = 0; a < t.length; ++a)
                        t[a].version == l.productVersion ? o.push(t[a]) : (r.push(t[a]), (n -= t[a].size));
                    o.sort(function (e, t) {
        ...
        (l.cachedFetch =
            ...
            function (o, a) {
                                ...
                                ? ((c.response = e),
                                  ...
                                  S(e, r.onProgress, r.enableStreamingDownload).then(function (e) {
                                      return (
                                          ...
                                          Promise.all([i.storeRequest(n, t), i.updateRequestMetaData(c.metaData)])
                                              .then(function () {
                                                  E(
                                                      "'" +
                                                          s +
                ...
                return (
                    ...
                    (c.revalidated = !1),
                    (c.metaData = { url: s, accessedAt: Date.now(), version: c.productVersion }),
                    (c.response = null),
                    c.enabled
                        ? i
                              .loadRequest(s)
                                            ...
                                            : ((e = s),
                                              ...
                                              (!n.headers.get("Last-Modified") && !n.headers.get("ETag"))
                                                  ...
                                                  : fetch(s, { method: "HEAD" }).then(function (t) {
                                                        return (
                                                            (c.revalidated = ["Last-Modified", "ETag"].every(
                                                                function (e) {
                                                                    return (
                                                                        !n.headers.get(e) ||
