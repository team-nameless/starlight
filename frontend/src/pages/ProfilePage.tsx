...
import NonStopAchieve from "../assets/images/Achievement-icons/Non-stop_achieve.png";
                    ...
                    <div className="profile-avatar-container">
                        ...
                        <div className="profile-tabs-section">
                            <div className="profile-tabs">
                                <span
                                    className={`profile-tab ${activeTab === "scoreRecord" ? "active" : ""}`}
                                    onClick={() => handleTabClick("scoreRecord")}
                                >
                                    Score Record
                                </span>
                                <span
                                ...
                                <span
                                    className={`profile-tab ${activeTab === "accountSetting" ? "active" : ""}`}
                                    onClick={() => handleTabClick("accountSetting")}
                                >
                                    Account Setting
                                </span>
                            </div>
                            <ProgressBar
                                current={levelData.exp}
                                total={levelData.expNeededForNextLevel}
                            ...
                            <div className="profile-account-setting">
                                ...
                                <div className="update-email">
                                    ...
                                    <input
                                        ...
                                        className="input-field"
                                    />
                                    <button onClick={handleEmailUpdate} className="update-button">
                                        Update
                                    </button>
                                </div>
                            </div>
